...
st.text("Welcome to BisonAdvisor - your academic compass in the journey through Howard University! At BisonAdvisor, we are committed to revolutionizing the undergraduate advising experience through cutting-edge technology and personalized support. Our service is meticulously")
st.text("About Us/n"
        " Vision /n "
